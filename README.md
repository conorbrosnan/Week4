...
About this R script
File with R code "run_analysis.R" perform 6 following steps (in accordance assigned task of course work):

Merging the training and the test sets to create one data set.
1.1 Here are the data for the project
...
6.1 Making second tidy data set
6.2 Writing second tidy data set in txt file